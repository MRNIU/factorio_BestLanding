...
- Turning the combinators off is recommended so they do not output into factory circuit networks.
...
Malformed marker groups are logged and skipped. A drill selected by two different resource types is also logged and skipped.
